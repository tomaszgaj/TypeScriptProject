...
},{"./Form":"../TS/Form.ts","./EmailField":"../TS/EmailField.ts","./SelectField":"../TS/SelectField.ts","./CheckboxField":"../TS/CheckboxField.ts","./TextAreaField":"../TS/TextAreaField.ts","./InputField":"../TS/InputField.ts"}],"../TS/FromCreator.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  FormCreator.prototype.newForm = function () {
    var fields = this._app.initSimpleForm();
  ...
  FormCreator.prototype.render = function () {
    var _this = this;

    var ids = this._LocStorage.getDocuments();

    var forms = [];
    ids.forEach(function (id) {
      forms.push(__assign({
        id: id
      }, _this._LocStorage.loadDocument(id)));
    });
...
var formCreater = new FormCreator();
formCreater.render();
},{"./App":"../TS/App.ts","./LocStorage":"../TS/LocStorage.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../TS/FromCreator.ts"], null)
//# sourceMappingURL=/FromCreator.1b4bc7ca.js.map